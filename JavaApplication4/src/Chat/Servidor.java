...
public class Servidor {
    ...
    public static void main(String args[]) throws InterruptedException {
        try {
            ...
            ServerSocket listenSocket_individual = new ServerSocket(6666);
            ServerSocket listenSocket_grupo = new ServerSocket(6699);


            while (true) {
                System.out.println("Servidor aguardando conexao ...");
                Socket clientSocket_individual = listenSocket_individual.accept();
                System.out.println("Cliente conectado ... Criando thread ... [INDIVIDUAL]");
                ClientThread c1 = new ClientThread(clientSocket_individual);
                
                System.out.println("Servidor aguardando conexao ...");
                Socket clientSocket_grupo = listenSocket_grupo.accept();
                System.out.println("Cliente conectado ... Criando thread ... [GRUPO]");
                ClientThread c2 = new ClientThread(clientSocket_grupo);
